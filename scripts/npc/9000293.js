...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		msg += "#L2# #d존의 진심이 담겨있는 꽃 #b(보상#i4021031# 10개)#l#k#n\r\n";
		msg += "#L3# #d슈미가 잃어버린 동전 #b(보상#i4021031# 10개)#l#k#n\r\n";
		msg += "#L4# #d크리슈라마의 만드라고라 #b(보상#i4021031# 10개)#l#k#n\r\n";
		msg += "#L5# #d작전 명! 폐광 탐사 작전 #b(보상#i4021031# 10개)#l#k#n\r\n";
		cm.sendSimple(msg);
	} else if (status == 1) {
		seld = sel;
		switch (sel) {
