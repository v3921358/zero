...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fs11#     #fUI/UIWindow5.img/Disguise/backgrnd4#\r\n";
		msg += "                  #L1##fs11##fc0xFF990033#[ZERO]#fc0xFF6600CC# 육성 다이어리 (필수)#l#n\r\n";
		msg += "                         #L7##fc0xFF990033#[ZERO]#fc0xFF6600CC# 성장 패스#l#n\r\n";
		msg += "                          #L2#일일&반복 퀘스트#l#n\r\n";
		msg += "                            #L3#레벨 보상 수령#l#n\r\n\r\n#fc0xFFFF3300#";
		msg += "#Cgray##fs11#――――――――――――――――――――――――――――――――――――――――\r\n#fc0xFFFF3300#";
		msg += "#L8##fUI/UIWindow4.img/pointShop/100296/iconShop# 메인 랭크 승급#l #fc0xFF990066##L13##fUI/UIWindow4.img/pointShop/3887/iconShop# 장비 메소강화#l#fc0xFF996600##L11##fUI/UIWindow4.img/pointShop/16393/iconShop# 기본악세 제작#l\r\n";
		msg += "#fc0xFFFF3300##L10##fUI/UIWindow4.img/pointShop/100296/iconShop# 보스 랭크 승급#l #fc0xFF990066##L14##fUI/UIWindow4.img/pointShop/3887/iconShop# 장비 옵션부여#l#fc0xFF996600##L12##fUI/UIWindow4.img/pointShop/16393/iconShop# 연금술 이용#l"+enter;
		msg += "#fc0xFFFF3300##L9##fUI/UIWindow4.img/pointShop/100296/iconShop# 스탯 랭크 승급#l#fc0xFF990066# #L15##fUI/UIWindow4.img/pointShop/3887/iconShop# 캐시 장비강화#l#fc0xFF990066#\r\n"+enter;
		cm.sendSimple(msg);
	} else if (status == 1) {
		seld = sel;
		switch (sel) {
