...
function action(mode, type, selection) {
    ...
    mobid = [8820008, 8820108]
    mobid2 = [8820010, 8820110];
    if (mode == -1) {
        cm.dispose();
        return;
    }
	...
	if (!cm.isLeader()) {
        ...
        mob1 = em.getMonster(mobid2[check]);
        eim.registerMonster(mob);
        eim.registerMonster(mob1);
        eim.getMapInstance(0).spawnMonsterOnGroundBelow(mob1, new java.awt.Point(8, -43));
        cm.getPlayer().getMap().killMonster(mob1, cm.getPlayer(), false, false, 1);
        eim.getMapInstance(0).spawnMonsterOnGroundBelow(mob, new java.awt.Point(8, -43));
