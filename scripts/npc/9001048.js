...
var nreward = [
	{'ngrade' : 1, 'items' : [[5068305, 10], [4310266, 1000]], 'select' : false},
	{'ngrade' : 2, 'items' : [[2430044, 2], [4310266, 1000], [4310237, 5000] , [4310308, 500]], 'select' : false},
	{'ngrade' : 3, 'items' : [[4310266, 2000], [4310237, 5000]], 'select' : false},
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		switch (sel) {
			...
			case 9:
				cm.dispose();
			cm.openNpcCustom(cm.getClient(), 9001048, "donationcash");
			break;
		}
	} else if (status == 2) {
		switch (seld) {
