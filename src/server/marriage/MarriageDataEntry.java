...
public class MarriageDataEntry {
    ...
    private boolean groomWhisCheck = false, brideWhisCheck = false;
    ...
    public void setBWhisCheck(boolean a) {
        if (brideWishList != null && brideWishList.size() > 0) {
            brideWhisCheck = true;
            return;
        }
        brideWhisCheck = a;
    ...
    public boolean getBWhisCheck() {
        return brideWhisCheck;
    }

    public void setGWhisCheck(boolean a) {
        if (groomWishList != null && groomWishList.size() > 0) {
            groomWhisCheck = true;
            return;
        }
        groomWhisCheck = a;
