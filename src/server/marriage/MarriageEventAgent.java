...
public class MarriageEventAgent {
    ...
    public void registerEvent(MapleCharacter chr) {
        ...
        World.Broadcast.broadcastMessage(CWvsContext.serverNotice(5, "", runningDataEntry.getGroomName() + "님과 " + runningDataEntry.getBrideName() + "님의 결혼이 " + channel + "채널 대성당에서 시작되려 합니다."));
