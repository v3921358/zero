...
public class MapleCarnivalFactory {
    ...
    private final MapleDataProvider dataRoot = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wz") + "/Skill.wz"));
    ...
    public static class MCSkill {
        ...
        public MapleBuffStat getDisease() {
            if (skillid <= 0) {
                return MapleBuffStat.getRandom();
            }
            return MapleBuffStat.getBySkill(skillid);
        }
    }
}
