...
public class MapleStorage implements Serializable {
    ...
    public void saveToDB(Connection con) {
        ...
        try {
            ...
            MapleInventoryType[] types = {MapleInventoryType.EQUIP, MapleInventoryType.USE, MapleInventoryType.SETUP, MapleInventoryType.ETC, MapleInventoryType.CASH};
            ...
            for (Map.Entry<MapleInventoryType, List<Item>> iter : listing.entrySet()) {
                ...
                if (con != null) {
                    ItemLoader.STORAGE.saveItems(iter.getValue(), con, accountId, iter.getKey(), false);
                } else {
                    ItemLoader.STORAGE.saveItems(iter.getValue(), accountId, iter.getKey(), false);
                }
            }
