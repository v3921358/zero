...
public class PetDataFactory {
    ...
    private static Map<Integer, Integer> petWonderGrade = new HashMap<Integer, Integer>();
    ...
    public static final int getWonderGrade(final int petId) {
        Integer ret = petWonderGrade.get(Integer.valueOf(petId));
        if (ret != null) {
            return ret;
        }
        final MapleData wonderData = dataRoot.getData("Pet/" + petId + ".img").getChildByPath("info/wonderGrade");
