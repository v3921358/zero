...
public class DatabaseConnection {
    ...
    public static final String MYSQLIPADDR = ServerProperties.getProperty("query.ip");
    public static final String MYSQLPORT = ServerProperties.getProperty("query.port");
    public static final String MySQLURL = "jdbc:mysql://"+MYSQLIPADDR+":"+MYSQLPORT+"/" + MYSQLSCHEMA + "?autoReconnect=true&characterEncoding=euckr&maxReconnects=5";
