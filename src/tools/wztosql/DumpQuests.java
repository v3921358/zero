...
public class DumpQuests {
    ...
    public void dumpQuests() throws Exception {
        if (!hadError) {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO wz_questdata(questid, name, autoStart, autoPreComplete, viewMedalItem, selectedSkillID, blocked, autoAccept, autoComplete, autoCompleteAction) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
